"""
fetch_data.py
Descarga precios de Yahoo Finance para todos los CEDEARs negociables en BYMA
que cotizan en NYSE / NASDAQ (listado oficial BYMA, actualizado 3/2/2026).
...
# ── Universo completo CEDEAR (NYSE / NASDAQ solamente) ───────────────────────
# Excluidos: B3, Frankfurt, London Stock Exchange, OTC, Bovespa
# (Yahoo Finance no los cubre de forma confiable)
...
CEDEARS = {
    ...
    "UPST":  {"name": "Upstart",                    "sector": "tech"},
    "INFY":  {"name": "Infosys",                    "sector": "tech"},
    "WIT":   {"name": "Wipro",                      "sector": "tech"},
    ...
    "XYZ":   {"name": "Square (Block)",             "sector": "tech"},
    ...
    "KOFM":  {"name": "Coca-Cola Femsa",            "sector": "consumer"},
    "FMX":   {"name": "FEMSA",                      "sector": "consumer"},
    ...
    "HOG":   {"name": "Harley-Davidson",            "sector": "consumer"},
    ...
    "LAR":   {"name": "Lithium Americas Argentina", "sector": "mining"},
    "NXE":   {"name": "NexGen Energy",              "sector": "mining"},

    # ── Brasil (ADR NYSE/NASDAQ) ───────────────────────────────────────────────
    ...
    "SNP":   {"name": "China Petroleum (Sinopec)",  "sector": "china"},
    "PTR":   {"name": "PetroChina",                 "sector": "china"},
    "SE":    {"name": "Sea Ltd (Singapur)",         "sector": "china"},
    "JOYY":  {"name": "JOYY Inc",                   "sector": "china"},
    "TCOM":  {"name": "Trip.com",                   "sector": "china"},
    "WBO":   {"name": "Weibo",                      "sector": "china"},

    # ── México ────────────────────────────────────────────────────────────────
    "CX":    {"name": "Cemex",                      "sector": "mexico"},
    "KOFM":  {"name": "Coca-Cola Femsa",            "sector": "mexico"},
    "FMX":   {"name": "FEMSA",                      "sector": "mexico"},
    "AMX":   {"name": "America Movil",              "sector": "mexico"},
    ...
    "IVV":   {"name": "iShares S&P 500 ETF",        "sector": "etf"},
    "IWM":   {"name": "iShares Russell 2000",       "sector": "etf"},
    "EEM":   {"name": "iShares MSCI Emerging Mkts", "sector": "etf"},
    ...
    "URA":   {"name": "Global X Uranium ETF",       "sector": "etf"},
    ...
    "XLC":   {"name": "Comm Services Select SPDR",  "sector": "etf"},
    ...
    "XLRE":  {"name": "Real Estate Select SPDR",    "sector": "etf"},
    "IBB":   {"name": "iShares NASDAQ Biotech",     "sector": "etf"},
    "IVW":   {"name": "iShares S&P 500 Growth",     "sector": "etf"},
    "IVE":   {"name": "iShares S&P 500 Value",      "sector": "etf"},
    "IJH":   {"name": "iShares S&P Mid-Cap",        "sector": "etf"},
    ...
    "ESGU":  {"name": "iShares ESG MSCI USA",       "sector": "etf"},
...
def fetch_all():
    ...
    print(f"[{datetime.now().isoformat()}] Descargando {len(TICKERS)} tickers...")
...
def main():
    ...
    print(f"\n✓ {len(data)} tickers guardados en data/market_data.json")
