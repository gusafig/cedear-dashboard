...
def compute_rsi(closes, period=14):
    """RSI simple sobre lista de precios de cierre."""
...
def compute_macd(closes):
    ...
    # Señal: EMA 9 del MACD (aproximación con últimos 35 valores)
    if len(closes) >= 35:
        macd_series = []
        k12 = 2 / 13
        k26 = 2 / 27
...
def fetch_all():
    ...
    start_date = end_date - timedelta(days=365)  # 1 año para calcular indicadores
    ...
    for sym in TICKERS:
        try:
            ...
            # Precio histórico últimos 90 días para el gráfico
